...
namespace Toolbox
{
	...
	{
		const float cof0 = GetMinor(m_matrix[1][1], m_matrix[2][1], m_matrix[3][1], m_matrix[1][2], m_matrix[2][2], m_matrix[3][2], m_matrix[1][3], m_matrix[2][3], m_matrix[3][3]);
		const float cof1 = GetMinor(m_matrix[0][1], m_matrix[2][1], m_matrix[3][1], m_matrix[0][2], m_matrix[2][2], m_matrix[3][2], m_matrix[0][3], m_matrix[2][3], m_matrix[3][3]);
		const float cof2 = GetMinor(m_matrix[0][1], m_matrix[1][1], m_matrix[3][1], m_matrix[0][2], m_matrix[1][2], m_matrix[3][2], m_matrix[0][3], m_matrix[1][3], m_matrix[3][3]);
		const float cof3 = GetMinor(m_matrix[0][1], m_matrix[1][1], m_matrix[2][1], m_matrix[0][2], m_matrix[1][2], m_matrix[2][2], m_matrix[0][3], m_matrix[1][3], m_matrix[2][3]);

		const float det = m_matrix[0][0] * cof0 - m_matrix[1][0] * cof1 + m_matrix[2][0] * cof2 - m_matrix[3][0] * cof3;
		if (fabs(det) <= EPSILON)
			return this->Identity();

		const float cof4 = GetMinor(m_matrix[1][0], m_matrix[2][0], m_matrix[3][0], m_matrix[1][2], m_matrix[2][2], m_matrix[3][2], m_matrix[1][3], m_matrix[2][3], m_matrix[3][3]);
		const float cof5 = GetMinor(m_matrix[0][0], m_matrix[2][0], m_matrix[3][0], m_matrix[0][2], m_matrix[2][2], m_matrix[3][2], m_matrix[0][3], m_matrix[2][3], m_matrix[3][3]);
		const float cof6 = GetMinor(m_matrix[0][0], m_matrix[1][0], m_matrix[3][0], m_matrix[0][2], m_matrix[1][2], m_matrix[3][2], m_matrix[0][3], m_matrix[1][3], m_matrix[3][3]);
		const float cof7 = GetMinor(m_matrix[0][0], m_matrix[1][0], m_matrix[2][0], m_matrix[0][2], m_matrix[1][2], m_matrix[2][2], m_matrix[0][3], m_matrix[1][3], m_matrix[2][3]);

		const float cof8 = GetMinor(m_matrix[1][0], m_matrix[2][0], m_matrix[3][0], m_matrix[1][1], m_matrix[2][1], m_matrix[3][1], m_matrix[1][3], m_matrix[2][3], m_matrix[3][3]);
		const float cof9 = GetMinor(m_matrix[0][0], m_matrix[2][0], m_matrix[3][0], m_matrix[0][1], m_matrix[2][1], m_matrix[3][1], m_matrix[0][3], m_matrix[2][3], m_matrix[3][3]);
		const float cof10 = GetMinor(m_matrix[0][0], m_matrix[1][0], m_matrix[3][0], m_matrix[0][1], m_matrix[1][1], m_matrix[3][1], m_matrix[0][3], m_matrix[1][3], m_matrix[3][3]);
		const float cof11 = GetMinor(m_matrix[0][0], m_matrix[1][0], m_matrix[2][0], m_matrix[0][1], m_matrix[1][1], m_matrix[2][1], m_matrix[0][3], m_matrix[1][3], m_matrix[2][3]);

		const float cof12 = GetMinor(m_matrix[1][0], m_matrix[2][0], m_matrix[3][0], m_matrix[1][1], m_matrix[2][1], m_matrix[3][1], m_matrix[1][2], m_matrix[2][2], m_matrix[3][2]);
		const float cof13 = GetMinor(m_matrix[0][0], m_matrix[2][0], m_matrix[3][0], m_matrix[0][1], m_matrix[2][1], m_matrix[3][1], m_matrix[0][2], m_matrix[2][2], m_matrix[3][2]);
		const float cof14 = GetMinor(m_matrix[0][0], m_matrix[1][0], m_matrix[3][0], m_matrix[0][1], m_matrix[1][1], m_matrix[3][1], m_matrix[0][2], m_matrix[1][2], m_matrix[3][2]);
		const float cof15 = GetMinor(m_matrix[0][0], m_matrix[1][0], m_matrix[2][0], m_matrix[0][1], m_matrix[1][1], m_matrix[2][1], m_matrix[0][2], m_matrix[1][2], m_matrix[2][2]);
	...
	{
		return	  m_matrix[0][0]
				* GetMinor(m_matrix[1][1], m_matrix[2][1], m_matrix[3][1], m_matrix[1][2], m_matrix[2][2], m_matrix[3][2], m_matrix[1][3], m_matrix[2][3], m_matrix[3][3])
	...
	inline float Mat4::GetMinor(const float p_m0, const float p_m1, const float p_m2, const float p_m3, const float p_m4, const float p_m5, const float p_m6, const float p_m7, const float p_m8)
	{
